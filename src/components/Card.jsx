  ...
  return (
    <>
      <div className="flex justify-items-center items-center align-middle">
        <div className="container max-w-6xl px-10 py-6 mx-auto rounded-lg shadow-sm dark:bg-gray-200">
          <div className="flex items-center justify-between">
            <span className="text-sm dark:text-gray-400">
              {new Date(prop.blog.date_added).toLocaleDateString("en-US", {
                year: "numeric",
                month: "short",
                day: "numeric",
              })}
          ...
          <div className="mt-3">
            ...
            <p className="mt-2">
              {prop.blog.content.length > 300
                ? prop.blog.content.substring(0, 300)
                : prop.blog.content}{" "}
              .....
            </p>
          </div>
